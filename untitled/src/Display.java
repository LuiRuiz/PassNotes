...
public class Display {
    ...
    private List <PasswordGenerator> ActivePasswordList;
	...
	*/
    ...
    private String[] loadCase(int i) {
        ...
        if (checkForEntryInLoop(i)) {
            returnCase = ActiveList.get(i + tracker).split(":", 2);
        } else {
    ...
    public void caseStructure() throws FileNotFoundException {
        ...
        switch (choice) { // will need to be changed to account for string to vector or string to item.
            ...
            case 8: {
                ...
                PasswordGenerator pass = new PasswordGenerator(passLength, accName);
    ...
    public void displayStructure() {
        for (int i = 0; i < 5; i++) {
            ...
            if (checkForEntryInLoop(i)) {
                ...
                String accName = ActiveList.get(i + tracker).split(":", 2)[0];
